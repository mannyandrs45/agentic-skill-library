...
**For complete lifecycle stage templates and SLA examples**: See [references/sales-revops-references.md](references/sales-revops-references.md)
...
**For detailed scoring templates and example models**: See [references/sales-revops-references.md](references/sales-revops-references.md)
...
**For routing decision trees and platform-specific setup**: See [references/sales-revops-references.md](references/sales-revops-references.md)
...
**For platform-specific workflow recipes**: See [references/sales-revops-references.md](references/sales-revops-references.md)
...
- **marketing/cold-email**: For outbound prospecting emails
- **marketing/email-sequence**: For lifecycle and nurture email flows
- **marketing/pricing-strategy**: For pricing decisions and packaging
- **marketing/analytics-tracking**: For tracking pipeline metrics and attribution
- **marketing/launch-strategy**: For go-to-market launch planning
- **marketing/sales-enablement**: For sales collateral, decks, and objection handling
