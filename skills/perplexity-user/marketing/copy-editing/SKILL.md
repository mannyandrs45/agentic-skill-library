...
If `/home/user/workspace/product-marketing-context.md` exists (or `/home/user/workspace/product-marketing-context.md` in older setups), read it before editing. Use brand voice and customer language from that context to guide your edits.
...
- **marketing/page-cro**: For broader page optimization beyond copy
- **marketing/marketing-psychology**: For understanding why certain edits improve conversion
- **marketing/ab-test-setup**: For testing copy variations
