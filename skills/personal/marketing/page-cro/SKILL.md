...
**For comprehensive experiment ideas by page type**: See [references/cro-references.md](references/cro-references.md)
...
- **marketing/signup-flow-cro**: If the issue is in the signup process itself
- **marketing/form-cro**: If forms on the page need optimization
- **marketing/popup-cro**: If considering popups as part of the strategy
- **marketing/copywriting**: If the page needs a complete copy rewrite
- **marketing/ab-test-setup**: To properly test recommended changes
