...
If `/home/user/workspace/product-marketing-context.md` exists (or `/home/user/workspace/product-marketing-context.md` in older setups), read it before applying mental models. Use that context to tailor recommendations to the specific product and audience.
...
- **marketing/page-cro**: Apply psychology to page optimization
- **marketing/copywriting**: Write copy using psychological principles
- **marketing/popup-cro**: Use triggers and psychology in popups
- **pricing-page optimization**: See page-cro for pricing psychology
- **marketing/ab-test-setup**: Test psychological hypotheses
