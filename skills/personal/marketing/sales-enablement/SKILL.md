...
**For full slide-by-slide guidance**: See [references/sales-revops-references.md](references/sales-revops-references.md)
...
**For templates by use case**: See [references/sales-revops-references.md](references/sales-revops-references.md)
...
**For the full objection library**: See [references/sales-revops-references.md](references/sales-revops-references.md)
...
**For full script templates**: See [references/sales-revops-references.md](references/sales-revops-references.md)
...
- **marketing/competitor-alternatives**: For public-facing comparison and alternative pages
- **marketing/copywriting**: For marketing website copy
- **marketing/cold-email**: For outbound prospecting emails
- **marketing/revops**: For lead lifecycle, scoring, routing, and pipeline management
- **marketing/pricing-strategy**: For pricing decisions and packaging
- **marketing/product-marketing-context**: For foundational positioning and messaging
